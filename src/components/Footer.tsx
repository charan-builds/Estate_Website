  ...
  return (
    <footer className="bg-[#1a3a52] text-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              />
              <button className="bg-[#1a3a52] px-4 py-2 rounded text-sm hover:bg-[#2a4a62] transition-colors">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 text-sm text-grey-300">
